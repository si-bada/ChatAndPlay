...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mProfileName = (TextView) findViewById(R.id.disp_name);
        mProfileStatus = (TextView) findViewById(R.id.profile_status);
        mProfileFriendsCount = (TextView) findViewById(R.id.profile_friends);
        mProfileSendReqBtn = (Button) findViewById(R.id.btn_request);
        mDeclineBtn = (Button) findViewById(R.id.btn_decline);
        ...
        mUsersDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Picasso.with(ProfileActivity.this).load(image).placeholder(R.drawable.bada).into(mProfileImage);
